...
interface MobileSessionDurationAnalyticsProps {
  className?: string;
  coachId?: string;
  clientId?: string;
  compact?: boolean;
...
const MobileSessionDurationAnalytics: React.FC<MobileSessionDurationAnalyticsProps> = ({
  className,
  coachId,
  clientId,
  compact = false
    ...
    <div className={cn("bg-white rounded-lg shadow-sm border", className)}>
      ...
      <div className="p-4">
        ...
        {analytics.length === 0 ? (
          ...
          <div className="space-y-3">
            {analytics.slice(0, compact ? 5 : analytics.length).map((session) => {
                ...
                <div key={session.sessionId} className="bg-gray-50 rounded-lg p-3">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-xs">
                    <div>
                      ...
                      <div className="font-medium">{session.plannedDuration}m</div>
                    </div>
                    <div>
                    ...
                    <div>
                      <div className="text-gray-500">Pauses/Adj</div>
                      <div className="font-medium">
                        {session.pauseCount}/{session.adjustmentCount}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {compact && analytics.length > 5 && (
              <div className="text-center pt-2">
                <button className="text-blue-600 text-sm font-medium">
                  {t('analytics.viewAll', 'View All Sessions')} ({analytics.length - 5} more)
                </button>
              </div>
            )}
          </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
            >
...
export default MobileSessionDurationAnalytics; 