...
const DebugPage = () => {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px', fontFamily: 'monospace' }}>
      <h1 style={{ color: '#e63946', textAlign: 'center', marginBottom: '30px' }}>
        🐛 React Debug Page 🐛
      </h1>
      ...
      <div style={debugSectionStyle}>
        ...
        <div>
          <p>
            <strong>Window Size:</strong> {windowSize.width}px × {windowSize.height}px
          </p>
          <p>
      ...
      <div style={debugSectionStyle}>
        ...
        <div>
          <p>
            <strong>DIV Elements:</strong> {domStats.divCount}
          </p>
          <p>
            <strong>Button Elements:</strong> {domStats.buttonCount}
          </p>
          <p>
            <strong>Link Elements:</strong> {domStats.linkCount}
          </p>
          <p>
            <strong>Image Elements:</strong> {domStats.imageCount}
          </p>
        </div>
      </div>
