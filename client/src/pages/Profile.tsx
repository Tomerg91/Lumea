...
const Profile = () => {
  ...
  const [imagePreview, setImagePreview] = useState<string | null>("https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=150&auto=format&fit=crop");
            ...
            <Card className="lumea-card">
              ...
              <form onSubmit={profileForm.handleSubmit(onProfileSubmit)}>
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    <div className="flex flex-col items-center space-y-3">
                      <div className="relative">
                        ...
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7"></path><path d="m16 3 5 5"></path><path d="M14 11a2 2 0 0 1 2-2 2 2 0 0 1 2 2v2h-4v-2Z"></path><path d="M14 17h4"></path></svg>
                        </label>
                        <input 
                          id="profile-image" 
                          type="file" 
                      ...
                      <p className="text-xs text-center text-muted-foreground">
                        Click the edit icon to change photo.<br />
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value: "client" | "coach") => profileForm.setValue("role", value)}
                        >
                ...
                <CardFooter className="justify-end">
                  <Button type="submit" className="bg-lumea-stone text-lumea-beige hover:bg-lumea-stone/90">
                    Save Changes
                  </Button>
                </CardFooter>
              </form>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button variant="outline" className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 border-red-200 hover:border-red-300 dark:border-red-900 dark:hover:border-red-800">
                      Delete Account
                    </Button>
                  </div>
                </div>
